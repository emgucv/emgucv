...
{
    public class ShapeDetector : IProcessAndRenderModel
    {
        ...
        public string ProcessAndRender(IInputArray imageIn, IInputOutputArray imageOut)
        {
            ...
            using (Mat cannyEdges = new Mat())
            {
                ...
                using (Mat triangleRectangleImage = new Mat(gray.Size, DepthType.Cv8U, 3)) //image to draw triangles and rectangles on
                using (Mat circleImage = new Mat(gray.Size, DepthType.Cv8U, 3)) //image to draw circles on
                using (Mat lineImage = new Mat(gray.Size, DepthType.Cv8U, 3)) //image to draw lines on
                {
