...
namespace Emgu.CV.XamarinForms
{
    ...
    public class SceneTextDetectionPage
#if __ANDROID__
        : AndroidCameraPage
#else
        : ButtonTextImagePage
#endif
    {
        ...
        private String _defaultButtonText = "Perform Scene Text Detection";
        private SceneTextDetector _detector;

        private String _StopCameraButtonText = "Stop Camera";
#if __ANDROID__
        private bool _isBusy = false;
#endif
        public SceneTextDetectionPage()
            : base()
        {
#if __ANDROID__
            ...
            _detector = new SceneTextDetector();
        }
        ...
        private async void OnButtonClicked(Object sender, EventArgs args)
        {
            ...
            {
                Stopwatch watch = Stopwatch.StartNew();
                var sceneTexts = _detector.Detect(images[0]);
                _detector.Render(images[0], sceneTexts);
