...
#else
static inline CV_NORETURN void throw_no_xstereo() { CV_Error(cv::Error::StsBadFunc, "The library is compiled without xstereo support. To use this module, please switch to the full Emgu CV runtime."); }
namespace cv {
	namespace stereo {
