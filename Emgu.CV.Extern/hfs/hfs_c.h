...
#else
static inline CV_NORETURN void throw_no_hfs() { CV_Error(cv::Error::StsBadFunc, "The library is compiled without hfs module support. To use this module, please switch to the full Emgu CV runtime."); }
