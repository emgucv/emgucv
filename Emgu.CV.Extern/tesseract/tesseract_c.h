...
CVAPI(bool) cveTessResultRendererHappy(tesseract::TessResultRenderer* resultRenderer);
CVAPI(int) cveTessResultRendererImageNum(tesseract::TessResultRenderer* resultRenderer);
