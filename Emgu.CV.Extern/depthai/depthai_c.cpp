...
/*
void daiXLinkOutSetStreamName(dai::node::XLinkOut* xlinkOut, cv::String* streamName)
{
#ifdef HAVE_DEPTHAI
	xlinkOut->setStreamName(*streamName);
#else
	throw_no_depthai();
#endif
}*/
...
void depthaiDeviceGetAvailableStreams(dai::Device* usb_device, std::vector< cv::String >* availableStreams)
{
#ifdef HAVE_DEPTHAI
...
CNNHostPipeline* depthaiDeviceCreatePipeline(dai::Device* usb_device, cv::String* config_json_str, std::shared_ptr<CNNHostPipeline>** hostedPipelinePtr)
{
#ifdef HAVE_DEPTHAI
