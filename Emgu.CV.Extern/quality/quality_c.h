...
#else
static inline CV_NORETURN void throw_no_quality() { CV_Error(cv::Error::StsBadFunc, "The library is compiled without quality module support. To use this module, please switch to the full Emgu CV runtime."); }
namespace cv {
namespace quality {
class QualityBase {};
class QualityMSE {};
...
CVAPI(void) cveQualityBaseCompute(cv::quality::QualityBase* qualityBase, cv::_InputArray* cmpImgs, cv::Scalar* score);
