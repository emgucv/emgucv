...
static inline CV_NORETURN void throw_no_text() { CV_Error(cv::Error::StsBadFunc, "The library is compiled without Text support. To use this module, please switch to the full Emgu CV runtime."); }
