...
#else
static inline CV_NORETURN void throw_no_calib3d() { CV_Error(cv::Error::StsBadFunc, "The library is compiled without calib3d support. To use this module, please switch to the full Emgu CV runtime."); }
