...
namespace Emgu.CV.Softcascade
{
   ...
   public class CudaSoftCascadeDetector : UnmanagedObject
   {
      ...
      public CudaSoftCascadeDetector(String trainedCascadeFileName, double minScale, double maxScale, int scales, SoftCascadeDetector.RejectionCriteria flags)
      {
         _ptr = SoftCascadeInvoke.cudaSoftCascadeDetectorCreate(trainedCascadeFileName, minScale, maxScale, scales, flags);
      }
      ...
      public GpuMat Detect(CudaImage<Bgr, Byte> image, GpuMat<int> rois, Emgu.CV.Cuda.Stream stream)
      {
