...
SET NETFX_CORE=""
IF "%3%"=="WindowsPhoneDevice81" SET NETFX_CORE="TRUE" 
IF "%3%"=="WindowsPhoneEmulator81" SET NETFX_CORE="TRUE"
IF "%3%"=="WindowsStore81" SET NETFX_CORE="TRUE"
IF "%3%"=="WindowsStore10" SET NETFX_CORE="TRUE"

SET OS_MODE=
IF "%1%"=="64" SET OS_MODE= Win64
IF "%3%"=="WindowsPhoneDevice81" SET OS_MODE= ARM
REM IF "%3%"=="WindowsPhoneEmulator81" SET OS_MODE= 32
...
IF "%3%"=="WindowsPhoneDevice81" GOTO CONFIGURE_WINDOWS_PHONE_81
IF "%3%"=="WindowsPhoneEmulator81" GOTO CONFIGURE_WINDOWS_PHONE_81
