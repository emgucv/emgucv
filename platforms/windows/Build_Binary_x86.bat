...
SET INTEL_DIR=%ICPP_COMPILER18%bin
...
SET INTEL_TBB=%ICPP_COMPILER18%tbb\include
...
IF %DEVENV%==%VS2017% SET TBB_DEV_ENV=vs2017
call "%ICPP_COMPILER18%tbb\bin\tbbvars.bat" %TBB_ARCH% %TBB_DEV_ENV%
