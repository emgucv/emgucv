...
IF %DEVENV%==%VS2008% SET CUDA_HOST_COMPILER="%VS90COMNTOOLS%..\..\VC\bin
IF %DEVENV%==%VS2010% SET CUDA_HOST_COMPILER="%VS100COMNTOOLS%..\..\VC\bin
IF %DEVENV%==%VS2012% SET CUDA_HOST_COMPILER="%VS110COMNTOOLS%..\..\VC\bin
