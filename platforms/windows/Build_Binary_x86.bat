...
REM IF EXIST "%PROGRAMFILES_DIR_X86%\Intel\openvino_2021" SET EMGU_CV_CMAKE_CONFIG_FLAGS=%EMGU_CV_CMAKE_CONFIG_FLAGS% -DINF_ENGINE_RELEASE:STRING="2021020000"
IF EXIST "%PROGRAMFILES_DIR_X86%\Intel\openvino" SET OPENVINO_DIR=%PROGRAMFILES_DIR_X86%\Intel\openvino
IF EXIST "%PROGRAMFILES_DIR_X86%\Intel\openvino" SET EMGU_CV_CMAKE_CONFIG_FLAGS=%EMGU_CV_CMAKE_CONFIG_FLAGS% -DINF_ENGINE_RELEASE:STRING="2020030001"
