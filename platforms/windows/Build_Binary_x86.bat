...
REM IF EXIST "%MSVC_14_12%" SET CUDA_HOST_COMPILER=%MSVC_14_12%
REM CUDA is not compatible with MSVC_14_12, forcing it to use 14.11
...
SET INTEL_COMPILER_DIR=%ICPP_COMPILER18%
...
SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DCMAKE_SYSTEM_NAME:String="WindowsStore" -DCMAKE_SYSTEM_VERSION:String="8.1" -DEMGU_CV_WITH_TESSERACT:BOOL=FALSE 
...
SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DCMAKE_SYSTEM_NAME:String="WindowsPhone"  -DCMAKE_SYSTEM_VERSION:String="8.1" -DEMGU_CV_WITH_TESSERACT:BOOL=FALSE  
GOTO CONFIGURE_WINDOWS_STORE_OR_PHONE
