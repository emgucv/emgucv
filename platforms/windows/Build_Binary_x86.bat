...
:WITH_GPU
REM Find cuda
REM SET CUDA_SDK_DIR=%CUDA_PATH%
REM We cannot use cuda 7 because the 32bit version of cublas is missing from that package
...
IF EXIST "%CUDA_SDK_DIR%" SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DCUDA_ARCH_BIN:STRING="1.1 1.2 1.3 2.0 2.1(2.0) 3.0 3.5 5.0 5.2"
)
