...
../configure_xcode.sh $CV_CONTRIB_OPTION catalyst $1 -DCMAKE_C_COMPILER="/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang" -DCMAKE_CXX_COMPILER="/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++" -DCMAKE_XCODE_ATTRIBUTE_CLANG_CXX_LANGUAGE_STANDARD="c++20" -DCMAKE_XCODE_ATTRIBUTE_CLANG_CXX_LIBRARY="libc++"  ${@:3}
