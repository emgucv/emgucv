...
if [ "$2" == "device" ]; then
    ...
    CV_TOOLCHAIN_OPTION=( -DAPPLE_FRAME_WORK:BOOL=TRUE )
    INSTALL_FOLDER=$INSTALL_FOLDER/OpenCV_catalyst_$3
    CMAKE_COMMON_OPTION=( -DIPHONEOS_DEPLOYMENT_TARGET:STRING=10.15 )
else
