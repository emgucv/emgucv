...
:SET_BUILD_TYPE
IF %DEVENV%==%MSBUILD35% SET BUILD_TYPE=/property:Configuration="Release" /property:Platform="%TARGETARCH%"
IF %DEVENV%==%MSBUILD40% SET BUILD_TYPE=/property:Configuration="Release" /property:Platform="%TARGETARCH%"
IF %DEVENV%==%VS2012% SET BUILD_TYPE=/Build "Release|%TARGETARCH%"
IF %DEVENV%==%VS2013% SET BUILD_TYPE=/Build "Release|%TARGETARCH%"
IF %DEVENV%==%VS2015% SET BUILD_TYPE=/Build "Release|%TARGETARCH%"
IF %DEVENV%==%VS2017% SET BUILD_TYPE=/Build "Release|%TARGETARCH%"
