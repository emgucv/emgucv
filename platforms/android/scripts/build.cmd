...
:FULL_BUILD_CONFIG
SET CMAKE_CXX_FLAGS_RELEASE_OPTION=-DCMAKE_CXX_FLAGS_RELEASE:STRING="-g0" 
SET CMAKE_C_FLAGS_RELEASE_OPTION=-DCMAKE_C_FLAGS_RELEASE:STRING="-g0" 
GOTO END_CONFIG

:CORE_BUILD_CONFIG
SET CMAKE_CXX_FLAGS_RELEASE_OPTION=-DCMAKE_CXX_FLAGS_RELEASE:STRING="-g0 -Os" 
SET CMAKE_C_FLAGS_RELEASE_OPTION=-DCMAKE_C_FLAGS_RELEASE:STRING="-g0 -Os" 
:END_CONFIG
...
REM -DCMAKE_SHARED_LINKER_FLAGS:STRING="-Wl,--gc-sections, -Wl,--exclude-libs,All" ^
REM -DCMAKE_INTERPROCEDURAL_OPTIMIZATION:BOOL=ON ^
