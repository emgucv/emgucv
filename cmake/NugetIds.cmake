...
IF(HAVE_ONNXRUNTIME)
	...
	IF(WITH_CUDA)
		SET(EMGU_ONNXRUNTIME_CUDA_NUGET_ID "Emgu.runtime.windows.onnxruntime.cuda")
		SET(EMGU_ONNXRUNTIME_CUDA_VERSION "${ONNXRUNTIME_VERSION}")
	ENDIF()
ENDIF()
...
IF(HAVE_WINDESKTOP_X64 AND HAVE_ONNXRUNTIME AND WITH_CUDA)
  SET(EMGUCV_WINDOWS_NUGET_DEPENDENCY "${EMGUCV_WINDOWS_NUGET_DEPENDENCY}
	  <dependency id=\"${EMGU_ONNXRUNTIME_CUDA_NUGET_ID}\" version=\"${EMGU_ONNXRUNTIME_CUDA_VERSION}\" />
	  ")
ENDIF()
