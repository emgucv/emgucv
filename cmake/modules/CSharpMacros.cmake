...
MACRO(ADD_CS_PREBUILD_COMMAND command)
        SET(CS_PREBUILD_COMMAND ${CS_PREBUILD_COMMAND} COMMAND)
        FOREACH(part ${command})
        SET(CS_PREBUILD_COMMAND ${CS_PREBUILD_COMMAND} ${part})
        ENDFOREACH(part)
ENDMACRO(ADD_CS_PREBUILD_COMMAND command)
