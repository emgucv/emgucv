...
IF(EMGU_SIGN_FOUND AND WIN32)    
  IF (NOT SIGNTOOL_FOUND)
    MESSAGE(FATAL_ERROR "EMGU_SIGN_FOUND=${EMGU_SIGN_FOUND}, but SIGNTOOL_FOUND=${SIGNTOOL_FOUND}")
  ENDIF()
ENDIF()  

IF(EMGU_VSIX_SIGN_FOUND AND WIN32)
  IF (NOT OPENVSIXSIGNTOOL_FOUND)
    MESSAGE(FATAL_ERROR "EMGU_VSIX_SIGN_FOUND=${EMGU_VSIX_SIGN_FOUND}, but OPENVSIXSIGNTOOL_FOUND=${OPENVSIXSIGNTOOL_FOUND}")
  ENDIF()
ENDIF()  

IF(EMGU_NUGET_SIGN_FOUND AND WIN32)
  IF (NOT NUGET_FOUND)
	MESSAGE(FATAL_ERROR "EMGU_NUGET_SIGN_FOUND=${EMGU_NUGET_SIGN_FOUND}, but NUGET_EXECUTABLE_FOUND=${NUGET_EXECUTABLE_FOUND}")
  ENDIF()
ENDIF()
