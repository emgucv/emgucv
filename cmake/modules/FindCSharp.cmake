...
IF(WIN32)
FIND_PROGRAM (CSC_EXECUTABLE csc c:/WINDOWS/Microsoft.NET/Framework/v2.0.50727 C:/Windows/Microsoft.NET/Framework/v3.5)
ELSE(WIN32)
FIND_PROGRAM (CSC_EXECUTABLE gmcs)
ENDIF(WIN32)

FIND_PROGRAM (GACUTIL_EXECUTABLE gacutil "C:/Program Files/Microsoft SDKs/Windows/v6.0A/bin" /usr/lib/mono/2.0)
...
IF (CSC_EXECUTABLE AND GACUTIL_EXECUTABLE AND AL_EXECUTABLE AND RESGEN_EXECUTABLE)
	SET (CSharp_FOUND TRUE)
ENDIF (CSC_EXECUTABLE AND GACUTIL_EXECUTABLE AND AL_EXECUTABLE AND RESGEN_EXECUTABLE)
