...
FIND_PROGRAM (CSC_EXECUTABLE_180 
NAMES csc 
PATHS
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Professional/Msbuild/Current/Bin/Roslyn"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Community/Msbuild/Current/Bin/Roslyn"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Enterprise/Msbuild/Current/Bin/Roslyn"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/BuildTools/Msbuild/Current/Bin/Roslyn"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Preview/Msbuild/Current/Bin/Roslyn"
CMAKE_FIND_ROOT_PATH_BOTH
)
MESSAGE(STATUS "CSC_EXECUTABLE_180: ${CSC_EXECUTABLE_180}")

FIND_PROGRAM (MSBUILD_EXECUTABLE_180 
NAMES msbuild 
PATHS
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Professional/Msbuild/Current/Bin"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Community/Msbuild/Current/Bin"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Enterprise/Msbuild/Current/Bin"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/BuildTools/Msbuild/Current/Bin"
"$ENV{${PROGRAM_FILES_X64_ENV_STR}}/Microsoft Visual Studio/18/Preview/Msbuild/Current/Bin"
CMAKE_FIND_ROOT_PATH_BOTH
)
MESSAGE(STATUS "MSBUILD_EXECUTABLE_180 : ${MSBUILD_EXECUTABLE_180}")
...
IF(CSC_EXECUTABLE_180 AND (NOT ${CSC_FOUND}))
  SET (CSC_EXECUTABLE ${CSC_EXECUTABLE_180})
  IF (CSC_PREFERRED_VERSION MATCHES "18.0")
	SET(CSC_FOUND TRUE)
  ENDIF()  
ENDIF()
...
IF(MSBUILD_EXECUTABLE_180)
  SET (MSBUILD_EXECUTABLE ${MSBUILD_EXECUTABLE_180})
ENDIF()
...
IF (DOTNET_EXECUTABLE)
  ...
  if(CMAKE_GENERATOR MATCHES "^Visual Studio 17")
	...
	message(STATUS "Using VS 17 generator: ${CMAKE_GENERATOR}, we will use dotnet ${DOTNET_VERSION}")
  ELSE()
	  EXECUTE_PROCESS(
...
ELSE()
  ...
  SET (NUGET_EXECUTABLE_NATIVE_PATH ${NUGET_EXECUTABLE})
ENDIF()  
MESSAGE(STATUS "NUGET_EXECUTABLE : ${NUGET_EXECUTABLE}")
MESSAGE(STATUS "NUGET_EXECUTABLE_NATIVE_PATH : ${NUGET_EXECUTABLE_NATIVE_PATH}")

FIND_PROGRAM (SIGNTOOL_EXECUTABLE 
NAMES signtool 
PATHS
"$ENV{${PROGRAM_FILES_X86_ENV_STR}}/Windows Kits/10/bin/10.0.26100.0/x64"
"$ENV{${PROGRAM_FILES_X86_ENV_STR}}/Windows Kits/10/bin/10.0.22621.0/x64"
"$ENV{${PROGRAM_FILES_X86_ENV_STR}}/Windows Kits/10/bin/10.0.22000.0/x64"
...
ELSE()
  ...
  SET (SIGNTOOL_EXECUTABLE_NATIVE_PATH ${SIGNTOOL_EXECUTABLE})
ENDIF()  

MESSAGE(STATUS "SIGNTOOL_EXECUTABLE : ${SIGNTOOL_EXECUTABLE}")
MESSAGE(STATUS "SIGNTOOL_EXECUTABLE_NATIVE_PATH : ${SIGNTOOL_EXECUTABLE_NATIVE_PATH}")
...
MARK_AS_ADVANCED(
  CSC_EXECUTABLE 
  SIGNTOOL_EXECUTABLE
  SIGNTOOL_EXECUTABLE_NATIVE_PATH
  VSTOOL_EXECUTABLE 
  AL_EXECUTABLE 
  GACUTIL_EXECUTABLE 
  MSBUILD_EXECUTABLE 
