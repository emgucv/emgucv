...
REM cp unityStoreIcons/README.txt Assets/Emgu.CV/Assets/Emgu.CV/Documentation/README.txt

cp ../Emgu.Util/*.cs Assets/Emgu.CV/Assets/Scripts/Emgu.Util/

cp ../Emgu.CV/*.cs Assets/Emgu.CV/Assets/Scripts/Emgu.CV/
cp -r ../Emgu.CV/CameraCalibration Assets/Emgu.CV/Assets/Scripts/Emgu.CV/
cp -r ../Emgu.CV/Capture Assets/Emgu.CV/Assets/Scripts/Emgu.CV/
