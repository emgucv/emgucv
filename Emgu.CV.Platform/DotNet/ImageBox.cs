...
namespace Emgu.CV.UI
{
    ...
    public partial class ImageBox : PanAndZoomPictureBox
    {
        ...
        /// </summary>
        private IInputArray _image;
        /// <summary>
        /// The image that is displayed
        /// </summary>
        private IInputArray _displayedImage;
        ...
        public new IInputArray Image
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    IInputArray imageToBeDisplayed = _image = value;
                            ...
                            foreach (Operation operation in _operationLists)
                            {
                                ...
                                {  //if this is an inplace operation 
                                    ...
                                    {  //make a clone if not already done so
                                        Mat m = new Mat();
                                        using (InputArray ia = _image.GetInputArray())
                                        using (Mat mat = ia.GetMat())
                                        {

                                            _displayedImage = mat.Clone();
                                        }
                                ...
                                {  //if this operation has return value
                                    ...
                                    isCloned = true;
                                    imageToBeDisplayed = operation.InvokeMethod(imageToBeDisplayed) as IInputArray;
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Browsable(false)]
        public IInputArray DisplayedImage
        {
            get
            {
