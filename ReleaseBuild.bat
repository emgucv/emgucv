...
mkdir %RELEASE-NAME%
cp Emgu.CV\README.txt Emgu.CV\Emgu.CV.License.txt bin\Emgu.CV.dll bin\cvextern.dll bin\Emgu.CV.ML.XML bin\Emgu.CV.ML.dll bin\Emgu.CV.XML bin\Emgu.CV.UI.dll bin\Emgu.CV.UI.XML bin\Emgu.Util.dll bin\Emgu.Util.XML lib\zlib.net.dll lib\zlib.net.license.txt lib\ZedGraph.dll lib\ZedGraph.XML lib\ZedGraph.license.txt %RELEASE-NAME%\
