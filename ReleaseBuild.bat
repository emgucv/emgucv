...
IF %DEVENV%==%MSBUILD35% SET BUILD_CMD=%DEVENV% %BUILD_TYPE% Solution\VS2005_MonoDevelop\Emgu.CV.sln 
IF %DEVENV%==%VS2005% SET BUILD_CMD=%DEVENV% %BUILD_TYPE% Solution\VS2005_MonoDevelop\Emgu.CV.sln
IF %DEVENV%==%VS2008% SET BUILD_CMD=%DEVENV% %BUILD_TYPE% Solution\VS2008\Emgu.CV.sln
