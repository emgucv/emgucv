...
if exist %RELEASE-NAME% rm -f %RELEASE-NAME%

mkdir %RELEASE-FOLDER%
mkdir %RELEASE-NAME%
cp Emgu.CV\README.txt Emgu.CV\Emgu.CV.License.txt Emgu.CV\bin\Release\Emgu.CV.dll Emgu.Utils\bin\Release\Emgu.Util.dll lib\zlib.net.dll lib\zlib.net.license.txt lib\ZedGraph.dll lib\ZedGraph.license.txt %RELEASE-NAME%
