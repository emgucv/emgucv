...
namespace Emgu.CV.Platform.Maui.UI
{
    public class AndroidCameraManager
    {
        ...
        */
        ...
        /// </summary>
        static readonly Java.Util.Concurrent.Semaphore _cameraOpenCloseLock = new Java.Util.Concurrent.Semaphore(1);
        ...
        bool SetUpCameraOutputs(int? preferredPreviewSize = null)
        {
            ...
            try
            {
                ...
                foreach (string cameraId in manager.GetCameraIdList())
                {
                    ...
                    var yuvs = map.GetOutputSizes((int)ImageFormatType.Yuv420888);
                    var yuvSize = 
