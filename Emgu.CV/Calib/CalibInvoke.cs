    ...
    public static partial class CvInvoke
    {
        ...
        */
           ...
           MCvTermCriteria termCriteria)
        {
            ...
            {
                double result = cveCalibrateCamera(
                   iaObjectPoints,
                   iaImagePoints,
                   ref imageSize,
                   ioaCameraMatrix,
            ...
            MCvTermCriteria termCrit)
        {
            ...
            {
                double result = cveStereoCalibrate1(
                    iaObjectPoints,
           ...
           MCvTermCriteria termCrit)
        {
            ...
            using (OutputArray oaF = f.GetOutputArray())
            {
                double result = cveStereoCalibrate2(
        ...
        public static bool Find4QuadCornerSubpix(IInputArray image, IInputOutputArray corners, Size regionSize)
        {
            ...
            {
                bool result = cveFind4QuadCornerSubpix(iaImage, ioaCorners, ref regionSize);
                CvInvoke.CheckError();
                return result;
            }
        }
           ...
           CvEnum.CalibCbType flags = CvEnum.CalibCbType.AdaptiveThresh | CvEnum.CalibCbType.NormalizeImage)
        {
            ...
            {
                bool result = cveFindChessboardCorners(iaImage, ref patternSize, oaCorners, flags);
                CvInvoke.CheckError();
                return result;
            }
        }
            ...
            CvEnum.CalibCbType flags = CalibCbType.Default)
        {
            ...
            using (OutputArray oaCorners = corners.GetOutputArray())
            {
                bool result = cveFindChessboardCornersSB(iaImage, ref patternSize, oaCorners, flags);
                CvInvoke.CheckError();
                return result;
            }
        }
        ...
        public static bool FindCirclesGrid(IInputArray image, Size patternSize, IOutputArray centers, CvEnum.CalibCgType flags, Feature2D featureDetector)
        {
            ...
            {
                bool result = cveFindCirclesGrid(iaImage, ref patternSize, oaCenters, flags, featureDetector.Feature2DPtr);
                CvInvoke.CheckError();
                return result;
            }
        }
