...
namespace Emgu.CV.Util
{
    ...
    public static class StructSize
    {
        ...
        private static readonly int _MCvTermCriteria;
        ...
        /// <summary>
        /// The size of MCvTermCriteria
        /// </summary>
        public static int MCvTermCriteria
        {
            get { return _MCvTermCriteria; }
        }
        ...
        static StructSize()
        {
            ...
            _MCvTermCriteria = Toolbox.SizeOf<MCvTermCriteria>();
        }
    }
}
