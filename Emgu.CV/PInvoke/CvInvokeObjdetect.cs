...
namespace Emgu.CV
{
    public static partial class CvInvoke
    {
        ...
        public static void GroupRectangles(VectorOfRect rectList, int groupThreshold, double eps)
        {
            cveGroupRectangles1(rectList, groupThreshold, eps);
        }
        [DllImport(ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
        internal static extern void cveGroupRectangles1(IntPtr rectList, int groupThreshold, double eps);
        ...
        /// <param name="groupThreshold">Minimum possible number of rectangles minus 1. The threshold is used in a group of rectangles to retain it.</param>
        /// <param name="eps">Relative difference between sides of the rectangles to merge them into a group.</param>
        public static void GroupRectangles(VectorOfRect rectList, VectorOfInt weights, int groupThreshold, double eps)
        {
            cveGroupRectangles2(rectList, weights, groupThreshold, eps);
        }
        [DllImport(ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
        internal static extern void cveGroupRectangles2(IntPtr rectList, IntPtr weights, int groupThreshold, double eps);
        ...
        /// <param name="groupThreshold">Minimum possible number of rectangles minus 1. The threshold is used in a group of rectangles to retain it.</param>
        /// <param name="eps">Relative difference between sides of the rectangles to merge them into a group.</param>
        public static void GroupRectangles(VectorOfRect rectList, VectorOfInt rejectLevels, VectorOfDouble levelWeights, int groupThreshold, double eps)
        {
        ...
        /// <param name="detectThreshold">detect threshold</param>
        /// <param name="winDetSize">win det size</param>
