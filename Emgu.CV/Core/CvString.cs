...
namespace Emgu.CV
{
    ...
    public class CvString : UnmanagedObject
    {
        ...
        public CvString(String s)
        {
            ...
            else
            {
                ...
                _ptr = CvInvoke.cveStringCreateFromStr(handle.AddrOfPinnedObject(), bytes.Length);
                handle.Free();
            }
        ...
        public override string ToString()
        {
            ...
            unsafe
            {
                return Encoding.UTF8.GetString((byte*) cStr.ToPointer(), size);
            }
#else       
    ...
    public static partial class CvInvoke
    {
        ...
        [DllImport(CvInvoke.ExternLibrary, CallingConvention = CvInvoke.CvCallingConvention)]
        internal static extern IntPtr cveStringCreateFromStr(IntPtr c, int size);
    }
}
