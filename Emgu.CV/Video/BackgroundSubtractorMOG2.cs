...
namespace Emgu.CV
{
    ...
    public partial class BackgroundSubtractorMOG2 : UnmanagedObject, IBackgroundSubtractor
    {
        ...
        {
            _ptr = CvInvoke.cveBackgroundSubtractorMOG2Create(history, varThreshold, shadowDetection, ref _backgroundSubtractorPtr, ref _algorithmPtr);
        }
        ...
        protected override void DisposeObject()
        {
            if (_ptr != IntPtr.Zero)
            {
                CvInvoke.cveBackgroundSubtractorMOG2Release(ref _ptr);
