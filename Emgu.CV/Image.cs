...
#elif __UNIFIED__
using CoreGraphics;
#elif NETFX_CORE || NET_STANDARD1_4 || UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE || UNITY_METRO || UNITY_EDITOR
#else
...
namespace Emgu.CV
{
       ...
       where TDepth : new()
    {
        ...
        {
#if NETFX_CORE || NET_STANDARD1_4 || UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE || UNITY_METRO
...
#if __UNIFIED__ || NETFX_CORE || NET_STANDARD1_4 || UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE || UNITY_METRO
#else
      /// <summary>
...
#if __UNIFIED__ || NETFX_CORE || NET_STANDARD1_4 || UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE || UNITY_METRO || UNITY_EDITOR
#else
      /// <summary>
