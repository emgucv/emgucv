...
namespace Emgu.CV.Test
{
   ...
   public class AutoTestMatrix
   {
      ...
      public void TestSubMatrix()
      {
         ...
         Matrix<float> submat = mat.GetSubMatrix(new System.Drawing.Rectangle(5, 5, 15, 15));
         for (int i = 0; i < 15; i++)
            for (int j = 0; j < 15; j++)
      ...
      public void TestConcate()
      {
         ...
         Matrix<float> m1 = mat.GetSubMatrix(new System.Drawing.Rectangle(0, 0, mat.Cols, 20));
         Matrix<float> m2 = mat.GetSubMatrix(new System.Drawing.Rectangle(0, 20, mat.Cols, mat.Rows - 20));
         Matrix<float> mat2 = m1.ConcateVertical(m2);
         Assert.IsTrue(mat.Equals(mat2));

         Matrix<float> m3 = mat.GetSubMatrix(new System.Drawing.Rectangle( 0, 0, 10, mat.Rows));
         Matrix<float> m4 = mat.GetSubMatrix(new System.Drawing.Rectangle( 10, 0, mat.Cols - 10, mat.Rows));
