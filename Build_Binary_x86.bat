...
REM SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DWITH_CUDA:BOOL=TRUE -DCUDA_NPP_LIBRARY_ROOT_DIR="C:/Documents and Settings/CHuang/Desktop/npp_3.2.16_win_32/SDK" -DCUDA_SDK_ROOT_DIR="C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v3.2" -DCUDA_VERBOSE_BUILD:BOOL=TRUE 
