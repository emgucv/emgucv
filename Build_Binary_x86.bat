...
IF "%3%"=="netfx_core" (
SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DNETFX_CORE:BOOL=TRUE -DWITH_DIRECTX:BOOL=FALSE -DWITH_OPENEXR:BOOL=FALSE -DWITH_TIFF:BOOL=FALSE -DEMGU_CV_WITH_TIFF:BOOL=FALSE -DWITH_PNG:BOOL=FALSE -DWITH_WEBP:BOOL=FALSE -DWITH_DSHOW:BOOL=FALSE -DWITH_WIN32UI:BOOL=FALSE -DWITH_VFW:BOOL=FALSE -DWITH_OPENCL:BOOL=FALSE 
) ELSE (
