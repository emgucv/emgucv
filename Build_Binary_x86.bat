...
SET CMAKE_CONF_FLAGS=%CMAKE_CONF_FLAGS% -DNETFX_CORE:BOOL=TRUE -DWITH_VIDEOINPUT:BOOL=FALSE -DWITH_OPENEXR:BOOL=FALSE -DWITH_TIFF:BOOL=FALSE -DWITH_PNG:BOOL=FALSE 
